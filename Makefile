...
postgres-create-table:
	...
	@docker exec -it ${POSTGRES_CONTAINER_NAME} psql -U ${POSTGRES_USER} -d ${POSTGRES_DW_DB} -f sql/ddl-jackjill-child-clothing-sales.sql
	@echo '==========================================================='
...
postgres-ingest-csv:
	...
	@echo 'Ingesting CSV...'
	@echo '_________________________________________'
	@docker exec -it ${POSTGRES_CONTAINER_NAME} psql -U ${POSTGRES_USER} -d ${POSTGRES_DW_DB} -f sql/ingest-jackjill-child-clothing-sales.sql
	@echo '==========================================================='
