...
correlation_rating_language = goodread_cleaned_df.stat.corr("average_rating", "num_pages")
correlation_rating_language = round(correlation_rating_language, 2)
...
correlation_rating_language_df = spark.createDataFrame(
    [(correlation_rating_language,)],
    ["correlation_rating_language"]
)
...
correlation_rating_language_df.write.jdbc(
    url=jdbc_url,
    table="correlation_rating_language",  
    mode="overwrite",
    properties=jdbc_properties
)
